...
var GLTFLoader = class _GLTFLoader {
  ...
  loadAnimationAsync(context, animation) {
    ...
    return import("./animationGroup-TKNLZS3H.js").then(({ AnimationGroup }) => {
      this._babylonScene._blockEntityCollection = !!this._assetContainer;
  ...
  async _loadAnimationChannelAsync(context, animationContext, animation, channel, onLoad) {
    ...
    await import("./glTFLoaderAnimation-UI4X35P2.js");
    let properties;
...
//# sourceMappingURL=chunk-RMI5MK34.js.map
