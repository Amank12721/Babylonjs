...
import {
  SerializationHelper
} from "./chunk-LW7WKGDV.js";
import {
  __decorate,
  serialize,
  serializeAsColor4
} from "./chunk-YPHLTIZU.js";
import {
  Color3
...
} from "./chunk-JUWP3LE5.js";
import {
  EffectWrapper
} from "./chunk-2YEJISSC.js";
import {
  GetClass,
  RegisterClass
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-OL2KVTZX.js").then((module) => this._dumpTools = module);
    }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-DWZ5RJD2.js");
    const textures = [];
...
//# sourceMappingURL=chunk-HI6MPFEN.js.map
