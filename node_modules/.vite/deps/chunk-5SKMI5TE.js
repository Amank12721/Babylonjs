...
function _GetCompatibleTextureLoader(extension, mimeType) {
  ...
  if (!_registeredTextureLoaders.has(extension)) {
    ...
    if (extension.endsWith(".dds")) {
      registerTextureLoader(".dds", () => import("./ddsTextureLoader-7NA4V3B7.js").then((module) => new module._DDSTextureLoader()));
    }
    if (extension.endsWith(".basis")) {
      registerTextureLoader(".basis", () => import("./basisTextureLoader-O3BQ2674.js").then((module) => new module._BasisTextureLoader()));
    }
    if (extension.endsWith(".env")) {
      registerTextureLoader(".env", () => import("./envTextureLoader-FYE7LKGW.js").then((module) => new module._ENVTextureLoader()));
    }
    ...
    if (extension.endsWith(".ktx") || extension.endsWith(".ktx2")) {
      registerTextureLoader(".ktx", () => import("./ktxTextureLoader-KGUBBSJN.js").then((module) => new module._KTXTextureLoader()));
      registerTextureLoader(".ktx2", () => import("./ktxTextureLoader-KGUBBSJN.js").then((module) => new module._KTXTextureLoader()));
    }
    ...
    if (extension.endsWith(".exr")) {
      registerTextureLoader(".exr", () => import("./exrTextureLoader-PS43BSHI.js").then((module) => new module._ExrTextureLoader()));
    }
  }
...
//# sourceMappingURL=chunk-5SKMI5TE.js.map
